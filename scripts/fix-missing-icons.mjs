...
const CUSTOM_ICONS = {
  ...
  // LuaRocks - Lua moon with rock/gem accent
  luarocks: {
    light: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="lrGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#2C2D72"/><stop offset="100%" style="stop-color:#00007C"/></linearGradient></defs><rect width="24" height="24" rx="5" fill="url(#lrGrad)"/><circle cx="10" cy="10" r="6" fill="none" stroke="white" stroke-width="1.5" opacity="0.9"/><circle cx="10" cy="10" r="6" fill="white" opacity="0.15"/><path d="M14 10a4 4 0 0 1-4 4 4 4 0 0 1 0-8c-.5 1-.5 2 0 4s1.5 3 4 4z" fill="white" opacity="0.3"/><polygon points="17,15 20,20 14,20" fill="#FFD700" opacity="0.85"/><polygon points="17,15.5 19.2,19.5 14.8,19.5" fill="white" opacity="0.2"/></svg>`,
    dark: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="lrGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#5C5CDB"/><stop offset="100%" style="stop-color:#3939B5"/></linearGradient></defs><rect width="24" height="24" rx="5" fill="url(#lrGrad)"/><circle cx="10" cy="10" r="6" fill="none" stroke="white" stroke-width="1.5" opacity="0.9"/><circle cx="10" cy="10" r="6" fill="white" opacity="0.1"/><path d="M14 10a4 4 0 0 1-4 4 4 4 0 0 1 0-8c-.5 1-.5 2 0 4s1.5 3 4 4z" fill="white" opacity="0.25"/><polygon points="17,15 20,20 14,20" fill="#FFE066" opacity="0.9"/><polygon points="17,15.5 19.2,19.5 14.8,19.5" fill="white" opacity="0.15"/></svg>`,
  },
  // MSVC - Visual Studio Build Tools purple shield
  msvc: {
    light: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="msvcGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#7B4FC2"/><stop offset="100%" style="stop-color:#5C2D91"/></linearGradient></defs><path d="M12 1L3 5v7c0 5.25 3.83 10.15 9 11.35C17.17 22.15 21 17.25 21 12V5L12 1z" fill="url(#msvcGrad)"/><path d="M12 2.5L4.5 5.8v6.2c0 4.5 3.2 8.7 7.5 9.7 4.3-1 7.5-5.2 7.5-9.7V5.8L12 2.5z" fill="none" stroke="white" stroke-width="0.5" opacity="0.3"/><text x="12" y="15.5" text-anchor="middle" font-family="Arial,sans-serif" font-size="8" font-weight="bold" fill="white" opacity="0.95">VS</text></svg>`,
    dark: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="msvcGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#A47DE8"/><stop offset="100%" style="stop-color:#845EC2"/></linearGradient></defs><path d="M12 1L3 5v7c0 5.25 3.83 10.15 9 11.35C17.17 22.15 21 17.25 21 12V5L12 1z" fill="url(#msvcGrad)"/><path d="M12 2.5L4.5 5.8v6.2c0 4.5 3.2 8.7 7.5 9.7 4.3-1 7.5-5.2 7.5-9.7V5.8L12 2.5z" fill="none" stroke="white" stroke-width="0.5" opacity="0.25"/><text x="12" y="15.5" text-anchor="middle" font-family="Arial,sans-serif" font-size="8" font-weight="bold" fill="white" opacity="0.95">VS</text></svg>`,
  },
  // MSYS2 - UNIX terminal on Windows style icon
  msys2: {
    light: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="msys2Grad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#9B2335"/><stop offset="100%" style="stop-color:#7A1A2A"/></linearGradient></defs><rect width="24" height="24" rx="5" fill="url(#msys2Grad)"/><rect x="3" y="5" width="18" height="14" rx="2" fill="#1a1a1a" stroke="white" stroke-width="0.5" opacity="0.9"/><rect x="3.5" y="5.5" width="17" height="3.5" rx="1.5" fill="#2a2a2a"/><circle cx="6" cy="7.25" r="0.8" fill="#ff5252"/><circle cx="8.5" cy="7.25" r="0.8" fill="#ffbd2e"/><circle cx="11" cy="7.25" r="0.8" fill="#27c93f"/><text x="5.5" y="14.5" font-family="monospace" font-size="4.5" font-weight="bold" fill="#27c93f">$_</text><rect x="12" y="12.5" width="7" height="1" fill="#4EC9B0" opacity="0.7"/><rect x="5.5" y="16" width="5" height="1" fill="#27c93f" opacity="0.5"/><rect x="11.5" y="16" width="4" height="1" fill="#CE9178" opacity="0.5"/></svg>`,
    dark: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="msys2Grad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#D4475A"/><stop offset="100%" style="stop-color:#B8334A"/></linearGradient></defs><rect width="24" height="24" rx="5" fill="url(#msys2Grad)"/><rect x="3" y="5" width="18" height="14" rx="2" fill="#1a1a1a" stroke="white" stroke-width="0.5" opacity="0.9"/><rect x="3.5" y="5.5" width="17" height="3.5" rx="1.5" fill="#2a2a2a"/><circle cx="6" cy="7.25" r="0.8" fill="#ff5252"/><circle cx="8.5" cy="7.25" r="0.8" fill="#ffbd2e"/><circle cx="11" cy="7.25" r="0.8" fill="#27c93f"/><text x="5.5" y="14.5" font-family="monospace" font-size="4.5" font-weight="bold" fill="#4AE68A">$_</text><rect x="12" y="12.5" width="7" height="1" fill="#6AD8C2" opacity="0.8"/><rect x="5.5" y="16" width="5" height="1" fill="#4AE68A" opacity="0.6"/><rect x="11.5" y="16" width="4" height="1" fill="#E0A882" opacity="0.6"/></svg>`,
  },
