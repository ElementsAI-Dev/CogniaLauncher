...
pub use git::{
    ...
    git_resolve_file_mark, git_resolve_file_ours, git_resolve_file_theirs, git_revert,
...
pub use terminal::{
    ...
    terminal_ps_find_module, terminal_ps_get_execution_policy, terminal_ps_get_module_detail,
