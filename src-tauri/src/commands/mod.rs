...
pub use download::{
    ...
    setup_download_manager, SharedDownloadManager,
};
pub use environment::{
...
pub use git::{
    git_add_submodule, git_add_to_gitignore, git_add_worktree, git_apply_mailbox,
    git_apply_patch, git_archive, git_bisect_bad, git_bisect_good, git_bisect_log,
    git_bisect_reset, git_bisect_skip, git_bisect_start, git_branch_rename,
    git_branch_set_upstream, git_cancel_clone, git_check_ignore, git_checkout_branch,
    git_cherry_pick, git_cherry_pick_abort, git_cherry_pick_continue, git_clean,
    git_clean_dry_run, git_clone, git_commit, git_create_branch, git_create_tag,
    git_deepen, git_delete_branch, git_delete_remote_branch, git_delete_tag, git_describe,
    git_discard_changes, git_extract_repo_name, git_fetch, git_format_patch, git_fsck,
    git_get_activity, git_get_ahead_behind, git_get_bisect_state, git_get_blame,
    git_get_branches, git_get_commit_detail, git_get_commit_diff, git_get_config,
    git_get_config_file_path, git_get_config_value, git_get_conflicted_files,
    git_get_contributors, git_get_diff, git_get_diff_between, git_get_executable_path,
    git_get_file_history, git_get_file_stats, git_get_gitignore, git_get_graph_log,
    git_get_hook_content, git_get_local_config, git_get_local_config_value, git_get_log,
    git_get_merge_rebase_state, git_get_rebase_todo_preview, git_get_reflog, git_get_remotes,
    git_get_repo_info, git_get_repo_stats, git_get_stashes, git_get_status, git_get_tags,
    ...
    git_lfs_ls_files, git_lfs_track, git_lfs_tracked_patterns, git_lfs_untrack,
    git_list_aliases, git_list_hooks, git_list_submodules, git_list_worktrees, git_merge,
    git_merge_abort, git_merge_continue, git_open_config_in_editor, git_prune_worktrees,
    git_pull, git_push, git_push_tags, git_rebase, git_rebase_abort, git_rebase_continue,
    git_rebase_skip, git_remote_add, git_remote_prune, git_remote_remove, git_remote_rename,
    git_remote_set_url, git_remove_config, git_remove_local_config, git_remove_submodule,
    git_remove_worktree, git_reset, git_resolve_file_mark, git_resolve_file_ours,
    git_resolve_file_theirs, git_revert, git_revert_abort, git_search_commits, git_set_config,
    git_set_config_if_unset, git_set_gitignore, git_set_hook_content, git_set_local_config,
    git_sparse_checkout_add, git_sparse_checkout_disable, git_sparse_checkout_init,
    git_sparse_checkout_list, git_sparse_checkout_set, git_squash, git_stage_all,
    git_stage_files, git_start_interactive_rebase, git_stash_apply, git_stash_branch,
    git_stash_drop, git_stash_pop, git_stash_push_files, git_stash_save, git_stash_show,
    git_sync_submodules, git_toggle_hook, git_unshallow, git_unstage_files, git_update,
    git_update_submodules, git_validate_url, git_verify_commit, git_verify_tag,
};
pub use github::{
...
pub use terminal::{
    ...
    terminal_measure_startup, terminal_check_shell_health,
...
pub use plugin::{
    plugin_call_tool, plugin_disable, plugin_enable, plugin_get_all_health, plugin_get_data_dir,
    plugin_get_health, plugin_get_info, plugin_get_locales, plugin_get_permissions,
    plugin_get_tools, plugin_get_ui_asset, plugin_get_ui_entry, plugin_grant_permission,
    plugin_import_local, plugin_install, plugin_list, plugin_list_all_tools, plugin_reload,
    plugin_check_all_updates, plugin_dispatch_event, plugin_export_data,
    plugin_get_settings_schema, plugin_get_settings_values, plugin_reset_health,
    plugin_revoke_permission, plugin_scaffold, plugin_set_setting, plugin_uninstall,
    plugin_update_all,
...
pub use wsl::{
    ...
    wsl_disk_usage, wsl_exec, wsl_export, wsl_get_capabilities, wsl_get_config,
    wsl_get_distro_config, wsl_get_ip, wsl_get_version_info, wsl_import, wsl_import_in_place,
    wsl_install_with_location, wsl_install_wsl_only, wsl_is_available, wsl_launch,
    wsl_list_distros, wsl_list_online, wsl_list_running, wsl_mount, wsl_move_distro,
    wsl_open_in_explorer, wsl_open_in_terminal, wsl_resize_distro, wsl_set_config, wsl_total_disk_usage,
