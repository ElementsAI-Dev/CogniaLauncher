...
- **组件设置工具条** — 新的 insight widgets 可以直接在编辑工具条里调整范围、分组和条目数量等轻量设置。
- **自定义对话框** — 管理组件目录、分类过滤、添加操作、可配置组件标记与恢复默认。
...
- **工作区趋势** — 基于每个 widget 的范围和指标设置展示安装、下载或更新趋势。
- **Provider 健康矩阵** — 以紧凑矩阵方式展示 provider / 环境健康状态和汇总计数。
