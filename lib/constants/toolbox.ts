...
export const TOOL_REGISTRY: ToolDefinitionWithMeta[] = [
  ...
  defineTool({
    ...
    icon: 'Braces',
    category: 'formatters',
    keywords: ['json', 'format', 'beautify', 'minify', 'pretty', 'indent', 'validate', 'sort', 'unicode'],
  ...
  defineTool({
    ...
    icon: 'Link',
    category: 'encoders',
    keywords: ['url', 'encode', 'decode', 'uri', 'percent', 'query', 'parameter', 'plus', 'space'],
  ...
  defineTool({
    ...
    icon: 'Fingerprint',
    category: 'generators',
    keywords: ['uuid', 'guid', 'random', 'unique', 'id', 'generate', 'v4', 'batch'],
  ...
  defineTool({
    ...
    icon: 'Hash',
    category: 'generators',
    keywords: ['hash', 'md5', 'sha', 'sha256', 'sha512', 'digest', 'checksum', 'sha384'],
  ...
  defineTool({
    ...
    icon: 'Shield',
    category: 'generators',
    keywords: ['password', 'generate', 'random', 'secure', 'strong', 'passphrase', 'batch'],
  ...
  defineTool({
    ...
    icon: 'Diff',
    category: 'text',
    keywords: ['diff', 'compare', 'text', 'difference', 'merge', 'patch', 'whitespace', 'case'],
