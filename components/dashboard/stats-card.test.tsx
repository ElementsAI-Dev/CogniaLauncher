...
describe("StatsCard", () => {
  ...
  it("renders description when provided", () => {
    render(
      <StatsCard title="Title" value={10} description="Test description" />,
    );
  ...
  it("renders loading skeleton when loading is true", () => {
    const { container } = render(
      <StatsCard title="Title" value={10} loading={true} />,
    );
  ...
  it("renders trend indicator with correct color for down direction", () => {
    render(
      <StatsCard title="Title" value={10} trend={{ direction: "down" }} />,
    );
...
describe("StatsCardSkeleton", () => {
  ...
  it("accepts custom className", () => {
    const { container } = render(
      <StatsCardSkeleton className="custom-class" />,
    );
