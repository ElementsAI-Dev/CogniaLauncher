...
const mockPackages: InstalledPackage[] = [
  ...
  { name: 'vue', version: '3.3.0', provider: 'npm', install_path: '/path', installed_at: '2024-01-01', is_global: true },
  { name: 'lodash', version: '4.17.21', provider: 'npm', install_path: '/path', installed_at: '2024-01-01', is_global: true },
  { name: 'axios', version: '1.4.0', provider: 'npm', install_path: '/path', installed_at: '2024-01-01', is_global: true },
  { name: 'express', version: '4.18.2', provider: 'npm', install_path: '/path', installed_at: '2024-01-01', is_global: true },
];
...
describe('PackageList', () => {
  ...
  it('shows no results message when search has no matches', () => {
    ...
    expect(screen.getByText('No packages match the search')).toBeInTheDocument();
  });
  ...
  it('navigates to package details when clicked', () => {
    ...
    expect(mockPush).toHaveBeenCalledWith('/packages?provider=npm&package=typescript');
  });
