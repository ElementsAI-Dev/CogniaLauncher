      ...
      <CardContent className="space-y-1">
        <div className="flex items-center justify-between py-2">
          <div className="space-y-0.5">
            <Label htmlFor="check-updates-on-start">
              {t("settings.checkUpdatesOnStart")}
            </Label>
            <p
              id="check-updates-on-start-desc"
        ...
        <div className="flex items-center justify-between py-2">
          <div className="space-y-0.5">
            <Label htmlFor="auto-install-updates">
              {t("settings.autoInstallUpdates")}
            </Label>
            <p
              id="auto-install-updates-desc"
              className="text-sm text-muted-foreground"
            >
        ...
        <div className="flex items-center justify-between py-2">
          <div className="space-y-0.5">
            <Label htmlFor="notify-on-updates">
              {t("settings.notifyOnUpdates")}
            </Label>
            <p
              id="notify-on-updates-desc"
              className="text-sm text-muted-foreground"
            >
