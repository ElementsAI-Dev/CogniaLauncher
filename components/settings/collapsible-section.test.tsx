...
describe("CollapsibleSection", () => {
  ...
  it("hides children content when collapsed", async () => {
    ...
    // Content should be hidden - Radix Collapsible uses data-state attribute
    const content = screen.queryByTestId("section-content");
    // Content may still be in DOM but not visible due to Collapsible animation/state
  ...
  it("shows reset option in dropdown menu", async () => {
    ...
    render(
      <CollapsibleSection {...defaultProps} onResetSection={onResetSection} />,
    );
