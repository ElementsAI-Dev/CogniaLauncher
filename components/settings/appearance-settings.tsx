      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between py-2">
          ...
          <Select value={theme} onValueChange={setTheme}>
            <SelectTrigger id="theme-select" className="w-32" aria-describedby="theme-desc">
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <Select value={locale} onValueChange={(v) => setLocale(v as 'en' | 'zh')}>
            <SelectTrigger id="language-select" className="w-32" aria-describedby="language-desc">
