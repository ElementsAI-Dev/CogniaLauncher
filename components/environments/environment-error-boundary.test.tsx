...
import { EnvironmentErrorBoundary, EnvironmentCardErrorBoundary } from './environment-error-boundary';
...
describe('EnvironmentErrorBoundary', () => {
  ...
  it('renders fallback UI when error occurs', () => {
    ...
    expect(screen.getByText('An error occurred while loading this component. Please try again.')).toBeInTheDocument();
  });
...
describe('EnvironmentCardErrorBoundary', () => {
  ...
  it('renders fallback with environment type when error occurs', () => {
    ...
    expect(screen.getByText('Failed to render the Node environment card.')).toBeInTheDocument();
  });
