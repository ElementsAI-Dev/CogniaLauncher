...
describe("InstalledVersions", () => {
  ...
  it("handles version with null size", () => {
    const versionsWithNullSize: InstalledVersion[] = [
      {
        version: "16.0.0",
        install_path: "/usr/local/node/16.0.0",
        size: null,
        is_current: false,
        installed_at: null,
      },
    ...
    render(
      <InstalledVersions {...defaultProps} versions={versionsWithNullSize} />,
    );
  ...
  it("handles version with null installed_at", () => {
    const versionsWithNullDate: InstalledVersion[] = [
      {
        version: "14.0.0",
        install_path: "/usr/local/node/14.0.0",
        size: 40000000,
        is_current: false,
        installed_at: null,
      },
    ...
    render(
      <InstalledVersions {...defaultProps} versions={versionsWithNullDate} />,
    );
