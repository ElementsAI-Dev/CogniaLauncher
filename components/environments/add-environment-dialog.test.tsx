  ...
  useLocale: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        "environments.addDialog.description":
          "Select a language and version manager",
        ...
        "environments.addDialog.selectVersionDesc":
        ...
        "environments.addDialog.autoSwitchDesc":
...
describe("AddEnvironmentDialog", () => {
  ...
  it("disables add button when no language is selected", () => {
    ...
    const submitButton =
      addButtons.find((el) => el.tagName === "BUTTON") ||
