...
const mockMessages = {
  en: {
    ...
    errors: {
      ...
      providerNotFound: 'Version manager not found. Install nvm, pyenv, or rustup first.',
...
describe('LocaleProvider', () => {
  describe('basic functionality', () => {
    ...
    it('translates nested keys', () => {
      ...
      expect(screen.getByTestId('theme-toggle')).toHaveTextContent('Toggle theme');
    });
  });
  ...
  describe('parameter interpolation', () => {
    ...
    it('interpolates parameters correctly', () => {
      ...
      expect(screen.getByTestId('with-params')).toHaveTextContent('5 versions installed');
    });
  });
