...
describe('InstalledFilterBar', () => {
  ...
  it('renders search input and provider selector', () => {
    ...
    expect(screen.getByPlaceholderText('Filter installed packages...')).toBeInTheDocument();
  });
  ...
  it('calls onFilterChange when search query changes', () => {
    ...
    expect(mockOnFilterChange).toHaveBeenCalledWith({ query: 'react', provider: null });
  });
