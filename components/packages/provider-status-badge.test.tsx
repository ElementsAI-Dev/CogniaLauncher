...
const mockProviders = [
  ...
  { id: 'conda', display_name: 'Conda', capabilities: ['Search', 'Install'], platforms: ['Windows'], priority: 2, is_environment_provider: true, enabled: false },
];

describe('ProviderStatusBadge', () => {
  it('renders provider count badge', () => {
    render(<ProviderStatusBadge providers={mockProviders as unknown as Parameters<typeof ProviderStatusBadge>[0]['providers']} />);
