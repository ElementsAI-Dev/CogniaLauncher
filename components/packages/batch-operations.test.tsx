...
const mockBatchResult: BatchResult = {
  successful: [{ name: 'package1', version: '1.0.0', action: 'installed', provider: 'pip' }, { name: 'package2', version: '1.0.0', action: 'installed', provider: 'pip' }],
  failed: [],
  skipped: [],
  total_time_ms: 1500,
};
...
describe('BatchOperations', () => {
  ...
  it('calls onBatchInstall when install is confirmed', async () => {
    ...
    const dialogInstallButton = screen.getAllByRole('button', { name: /install/i }).find(
