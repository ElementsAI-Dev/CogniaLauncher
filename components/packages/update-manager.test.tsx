...
const mockUpdates = [
  { package_id: 'pip:numpy', name: 'numpy', current_version: '1.23.0', latest_version: '1.24.0', provider: 'pip', is_pinned: false, is_breaking: false, change_type: 'minor' as const },
  { package_id: 'pip:pandas', name: 'pandas', current_version: '1.5.0', latest_version: '2.0.0', provider: 'pip', is_pinned: false, is_breaking: true, change_type: 'major' as const },
];
...
const defaultProps = {
  ...
  onUpdateSelected: jest.fn().mockResolvedValue({ successful: [], failed: [], skipped: [], total_time_ms: 0 }),
  onUpdateAll: jest.fn().mockResolvedValue({ successful: [], failed: [], skipped: [], total_time_ms: 0 }),
