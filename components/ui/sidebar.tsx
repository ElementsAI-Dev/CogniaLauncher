...
// Titlebar height - will be overridden by app-shell when titlebar is present
const TITLEBAR_HEIGHT_DEFAULT = "0px"
          ...
          style={
            {
              ...
              "--titlebar-height": TITLEBAR_HEIGHT_DEFAULT,
              ...style,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed z-10 hidden w-(--sidebar-width) transition-[left,right,width,top,height] duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] md:flex",
          // Position below titlebar when it exists (desktop Tauri mode)
          "top-[var(--titlebar-height)] h-[calc(100svh-var(--titlebar-height))]",
          side === "left"
