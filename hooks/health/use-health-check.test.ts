...
describe('useHealthCheck', () => {
  ...
  it('should expose normalized scope diagnostics in summary', () => {
    ...
    expect(result.current.summary.issueCount).toBe(5);
    expect(result.current.summary.verifiedIssueCount).toBe(3);
